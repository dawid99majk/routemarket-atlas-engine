...
- Source coverage is too thin for publication.
...
- Confirm surface, fuel, local rules, border/insurance needs, and emergency fallback points.
...
GPX not validated or not available.

## GeoJSON validation

GeoJSON passed basic FeatureCollection validation.
